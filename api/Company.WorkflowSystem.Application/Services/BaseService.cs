...
namespace Company.WorkflowSystem.Application.Services
{
    public class BaseService
    {
        ...
        public async Task<ConfigurationReader> GetConfigurationEntries(ConfigurationGroupIdentifiersEnum groupIdentifier)
        {
            ...
            {
                Entries = (await _repo.ProjectedList((ConfigurationEntry group) => new { group.Identifier, group.Content },
                group => group.ConfigurationGroup.Identifier == groupIdentifier))
