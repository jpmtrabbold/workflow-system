...
using Company.WorkflowSystem.Database.ExtensionMethods;

namespace Company.WorkflowSystem.Database.Context
{
    public class DataSeeding
    {
        ...
        private static void Configuration(ModelBuilder mb)
        {
            ...
            groupId = mb.HasData(new ConfigurationGroup { Id = 2, Name = "ABC Integration", Description = "Data related to the integration of ABC Trades into WorkflowSystem", Identifier = ConfigurationGroupIdentifiersEnum.AbcTradesIntegration });
            mb.HasData(new ConfigurationEntry
            {
                Id = 2,
                Name = "Deal Category",
        ...
        static void MainWorkflowStatuses(ModelBuilder mb)
        {
            ...
            (answerYes, answerNo) = AddMandatoryTaskWithYesNoWithNoCausingAction(null, mb, action, 85, null, "Do terms of signed PPA match WorkflowSystem?",
            ...
            (answerYes, answerNo) = AddMandatoryTaskWithYesNoWithNoCausingAction(null, mb, action, 107, null, "Do terms of signed Confirmation match WorkflowSystem?",
                rejectMiddleOfficeCheckActionId,
                Combine(ElectricityOTCHedgesDealTypes));
            ...
            (answerYes, answerNo) = AddMandatoryTaskWithYesNoWithNoCausingAction(null, mb, action, 149, null, "Do terms of signed Contract match WorkflowSystem?",
                rejectMiddleOfficeCheckActionId,
