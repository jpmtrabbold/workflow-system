...
import { AppBarContainerWithDrawerStore, appBarContainerWithDrawerStoreDisposer } from "./AppBarContainerWithDrawerStore"
...
export const AppBarContainerWithDrawer = observer((props: React.PropsWithChildren<AppBarContainerWithDrawerProps>) => {
    ...
    const store = useStore(source => new AppBarContainerWithDrawerStore(source), { bigScreen, ...props, initialDrawerOpen: props.initialDrawerOpen }, appBarContainerWithDrawerStoreDisposer)
