...
using Company.DealSystem.Web.Middleware;
using Hangfire;
...
using Company.DealSystem.Web.Hangfire;
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSwaggerDocument((x) =>
            {
                x.PostProcess = document =>
                {
                    ...
                    document.Info.Title = "DealSystem API";
                    document.Info.Description = $"API for the following DealSystem front-end: {Configuration.GetValue<string>("FrontEndBaseUrl")}";
                };
            ...
            services.AddDbContext<TradingDealsContext>
                (options => options
                .UseSqlServer(connection,  b => b.MigrationsAssembly("Company.DealSystem.Web"))
                );
